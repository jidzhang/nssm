 ...
 * nssm_testable.cpp
 *
 * Copies of testable pure functions from nssm.cpp and service.cpp.
 * These are compiled into the test binary so we don't need to link
 * the entire NSSM codebase (which has _tmain, Windows service APIs, etc).
 *
 * KEEP IN SYNC with the original implementations.
 */
...
/* ============================================================ */
/* Functions from nssm.cpp                                       */
/* ============================================================ */

/* Are two strings case-insensitively equivalent? (nssm.cpp:19) */
...
/* Convert a string to a number. (nssm.cpp:28, 3-arg version) */
...
/* Convert a string to a number. (nssm.cpp:55, 2-arg wrapper) */
...
/* Does a char need to be escaped? (nssm.cpp:62) */
...
/* Does a char need to be quoted? (nssm.cpp:75) */
...
/* Quote a string for command line use. (nssm.cpp:88) */
...
/* Remove basename of a path. (nssm.cpp:188) */
